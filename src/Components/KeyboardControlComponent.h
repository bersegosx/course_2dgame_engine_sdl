...
#ifndef INC_2DGAME_ENGINE_KEYBOARDCONTROLCOMPONENT_H
#define INC_2DGAME_ENGINE_KEYBOARDCONTROLCOMPONENT_H
...
//            return std::string(static_cast<int>(key[0]));
        }
...
#endif //INC_2DGAME_ENGINE_KEYBOARDCONTROLCOMPONENT_H
